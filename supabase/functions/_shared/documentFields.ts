// Shared by the app (through src/lib/documentFields.ts) and the scheduled
// reader in supabase/functions/document-reader. It imports nothing, and must
// keep importing nothing: Deno and Vite resolve imports differently.
