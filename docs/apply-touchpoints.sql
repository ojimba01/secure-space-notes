-- ============================================================
-- APPLY THIS BEFORE USING THE NEW TOUCHPOINT SCREENS.
--
-- Paste into the Supabase SQL editor for project gotwcbjywtdlyrtfjqnw and run.
-- It is idempotent: running it twice is harmless.
--
-- Until it runs, saving a touchpoint fails — the form writes a duration and a
-- staged NJHMIS progress note, and neither column nor table exists yet.
-- Same file as supabase/migrations/20260827001000_touchpoint_start_today.sql.
-- ============================================================
